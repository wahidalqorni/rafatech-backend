                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form id="formSubmit" method="POST" action="{{ url('store-product') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <input type="kode_product" class="form-control @error('kode_product') is-invalid @enderror"
                                        ...
                                        placeholder="Enter kode product" value="{{ old('kode_product') }}" required>
                                    @error('kode_product')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nama_product') is-invalid @enderror"
                                        ...
                                        placeholder="Enter nama product" value="{{ old('nama_product') }}" required>
                                    @error('nama_product')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kategori" class="form-control @error('kategori') is-invalid @enderror"
                                        ...
                                        <option value="Pecah Belah" {{ old('kategori') === 'Pecah Belah' ? 'selected' : '' }}>Pecah Belah</option>
                                    </select>
                                    @error('role')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('harga') is-invalid @enderror"
                                        ...
                                        placeholder="Enter harga product" value="{{ old('harga') }}" required>
                                    @error('harga')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="10">{{ old('deskripsi') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control @error('gambar') is-invalid @enderror"
                                        ...
                                        placeholder="Enter nama product" value="{{ old('gambar') }}" required>
                                    @error('gambar')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
